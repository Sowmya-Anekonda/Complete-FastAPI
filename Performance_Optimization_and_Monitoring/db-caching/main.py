...
def init_db():
    ...
    """)
    cursor.execute("INSERT INTO users (id, name, age) VALUES (1, 'Mike', 40)")
    cursor.execute("INSERT INTO users (id, name, age) VALUES (2, 'Jim', 30)")
    cursor.execute("INSERT INTO users (id, name, age) VALUES (3, 'Pam', 20)")
    conn.commit()
    conn.close() 
